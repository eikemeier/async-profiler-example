""" async-profiler 2.6 dependencies. """

load("@bazel_tools//tools/build_defs/repo:http.bzl", "http_archive")

def async_profiler26_repositories():
    http_archive(
        name = "async_profiler26_linux_x64",
    ...
    http_archive(
        name = "async_profiler26_linux_arm64",
        build_file = "//third_party/async_profiler:BUILD.async_profiler.bazel",
